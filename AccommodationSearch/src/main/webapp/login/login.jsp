                        ...
                        <form action="<%=request.getContextPath()%>/login" class="sign-in-form" method="post">
                            ...
                            <div class="actual-form">
                                <div class="input-wrap">
                                    <input type="text" minlength="4" class="input-field" name="username" autocomplete="on" required/>
                                    <label>Name</label>
                                </div>

                                <div class="input-wrap">
                                    <input type="password" minlength="4" class="input-field" name="password" autocomplete="on" required/>
...
main {
    ...
    background-image: linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(https://res.cloudinary.com/ddrjnfihc/image/upload/v1668565332/Home/homepage/fu_vj7koe.jpg);
